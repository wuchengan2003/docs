...
侧边栏的「技能」页面提供技能空间管理和 Dev Sandbox 技能生成。在此页面可以创建和管理技能空间、上传和浏览技能、以及通过 Dev Sandbox 从自然语言描述生成新技能或优化已有技能。生成技能使用独立的 AgentKit DevEnv Tool，与「使用内置智能体和 Skill 创建」中的 CodeEnv 模式互不影响。
