...
Studio capabilities such as video creation require persistent object storage to save reference assets and generated results. Studio uses TOS as the persistent storage backend.
