...
- **Agent info**: reads the Runtime-provided name, model, description, sub-agents, tools, skills, available search sources, and mounted components with their backend types. It does not include system prompts, credentials, or environment-variable values.
