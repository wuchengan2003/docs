...
| Artifacts | Browse documents, images, and videos generated in conversations. |
...
The Artifacts tab consolidates documents, images, and videos generated during conversations. Artifacts are grouped by session source, showing the associated app, session, and creation time, with type filtering and search support. Click an artifact to preview images or videos; document artifacts support inline preview.

<Note>
  Artifacts are collected from session events of deployed agents. To view artifacts, ensure Studio is connected to a deployed Runtime and that sessions with artifact events exist.
</Note>
